...
public class CustomRecipeManager {
    ...
    public CustomRecipeManager(DynaBeaconPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void load() {
        ...
        try {
            org.bukkit.NamespacedKey key = new org.bukkit.NamespacedKey(plugin, "dynabeacon");
        ...
        plugin.getLogger().info("Receta custom de DynaBeacon registrada.");
    }
