...
public class StorageManager {
    ...
    public List<BeaconData> loadBeacons() {
        ...
        if (section == null) return beacons;
        ...
        for (String id : section.getKeys(false)) {
            ...
            try {
                if (ownerRaw != null && !ownerRaw.isEmpty()) owner = UUID.fromString(ownerRaw);
            ...
            beacons.add(new BeaconData(id, uniqueId, location, owner, range, level, effects, activeEffects, trustedPlayers, protectBaseBlocks));
        }
