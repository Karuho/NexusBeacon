...
public class MySqlBeaconStorageProvider implements BeaconStorageProvider {
    ...
    public MySqlBeaconStorageProvider(DynaBeaconPlugin plugin) {
        this.plugin = plugin;
        ...
        String database = config.getString("storage.mysql.database", "dynabeacon");
        ...
        String prefix = config.getString("storage.mysql.table-prefix", "dynabeacon_");
        ...
        hikari.setPoolName("DynaBeacon-MySQL");
    ...
    private void prepareTable() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new IllegalStateException("No se pudo preparar la tabla MySQL de DynaBeacon.", exception);
        }
    }
