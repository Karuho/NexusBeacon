...
public class SpawnerMetaHook {
    ...
    public void load() {
        ...
        if (enabled) {
            Bukkit.getLogger().info("[DynaBeacon] SpawnerMeta detectado y hook cargado.");
        }
    }
    ...
    public boolean setReducedDelay(Block block, int targetMaxTicks) {
        ...
        try {
            ...
            Bukkit.getLogger().info("[DynaBeacon] SpawnerMeta: spawner en "
            ...
            if (currentDelay > targetMaxTicks) {
                ...
                Bukkit.getLogger().info("[DynaBeacon] SpawnerMeta: delay actualizado "
                        + currentDelay + " -> " + targetMaxTicks + " ticks");
            } else {
                Bukkit.getLogger().info("[DynaBeacon] SpawnerMeta: delay " + currentDelay
            ...
            Bukkit.getLogger().warning("[DynaBeacon] Error SpawnerMeta API: " + throwable.getClass().getSimpleName()
